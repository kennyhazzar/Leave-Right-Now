var tnt = require('./miroVariables.js')
...
exports.milestoneTitleCount = (lastRow, dataMilestone) => {
    var tempArray = [];
    milestoneBlanks = tnt.isBlank(lastRow, dataMilestone);
    for (var Jungle = 0; Jungle < lastRow; Jungle++) {
...
exports.milestoneTitle = (data, lastRow) => {
    var tempArray = [];
    milestoneBlanks = tnt.isBlank(lastRow, data);
    for (var Jungle = 0; Jungle < lastRow; Jungle++) {
